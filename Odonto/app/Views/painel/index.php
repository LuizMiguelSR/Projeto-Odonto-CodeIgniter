...
<?= $this->section('content') ?>
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        ...
        <?= $this->include('painel\includes\sidebar') ?>
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="#" class="btn btn-light">+ Cadastrar Usuário</a>
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex justify-content-center">
                                        <button type="button" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" data-bs-toggle="modal" data-bs-target="#exampleModal_<?= $usuario['id'] ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
                                                <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
                                            </svg>
                                        </button>
                                        
                                        <div class="modal fade" id="exampleModal_<?= $usuario['id'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
