<aside class="bg-custom text-light py-4" style="width: 250px;">
    <div class="menu">
        ...
        <a href="#" class="w-100 d-flex align-items-center gap-2 link-light text-decoration-none mt-2 py-3 px-3 ms-1 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(-.125rem, 0, 0);">
